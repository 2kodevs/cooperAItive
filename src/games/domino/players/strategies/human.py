...
class Human(BasePlayer):
    ...
    def filter(self, valids):
        ...
        while True:
            try:
                a, b, h = input("The format to select your move is (#1, #2, head) without the brackets, were head is 0 o 1 indicating the left and right sides of the table respectively.\nType the piece you want play: ").split(',')
