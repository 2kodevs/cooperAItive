...
def experiment_heuristic_vs_mcts():
    ...
    args = parser.parse_args(['play', '-p0', 'heuristic', '-p1', *player, "-v", '-rep', '1'])
    x = args.command(args)

    print("    mcts_vs_heuristic:", end=" ", flush=True)
    args = parser.parse_args(['play', '-p1', 'heuristic', '-p0', *player, "-v", '-rep', '1'])
    y = args.command(args)
...
def experiment_heuristic_vs_a0():
    ...
    player = ['a0', '1', '1', 'module/training/checkpoints/experimet_player.ckpt', '0']
...
def experiment_heuristic_vs_a0coop():
    ...
    player = ['a0', '1', '1', 'module/training/checkpoints/experimet_player.ckpt', "13"]
